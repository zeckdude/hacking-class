    ...
    <div class="exercise">
      ...
      <form method="post" action="{{action('SqlInjectionController@findUsers')}}">
        ...
        <div class="buttons-container">
          <input type="submit" class="button" name="risky-search" value="Risky Search" />
          <input type="submit" class="button" name="safe-search" value="Safe Search" />
        </div>
      </form>

      @if(isset($found_users))
        <p class="query">
          @if(isset($found_users_beginning_query))
            <span>
